...
public class PassValidatorTest {
  ...
  @Test
  public void characterValidator_CorrectAllCharacters_Pass_2(){
    assertTrue(PassValidator.isValidText("asdASDn12$"));
  }
  ...
  @Test
  public void characterValidator_InvalidAlpha(){
    assertFalse(PassValidator.isValidText("Helloworld"));
  }

  @Test
  public void characterValidator_InvalidNumeric(){
    assertFalse(PassValidator.isValidText("123456"));
  }

  @Test
  public void characterValidator_InvalidSymbol(){
    assertFalse(PassValidator.isValidText("!#$%&/"));
  }

  @Test
  public void characterValidator_InvalidTooShort(){
  ...
  @Test
  public void characterValidator_InvalidRequiredLowercaseCharacter(){
    assertFalse(PassValidator.isValidText("1234AB@"));
  }
  ...
  @Test
  public void characterValidator_EmptyString(){
    assertFalse(PassValidator.isValidText(""));
  }

  @Test
  public void characterValidator_NullNumeric(){
