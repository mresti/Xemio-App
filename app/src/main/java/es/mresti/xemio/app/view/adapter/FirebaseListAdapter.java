 ...
 * It handles all of the child events at the given Firebase location. It marshals received data
 * into
 * the given
 * class type. Extend this class and provide an implementation of <code>populateView</code>, which
 * will be given an
 * instance of your list item mLayout and an instance your class that holds your data. Simply
 * populate the view however
...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
   ...
   * that you provide
   * @param mLayout This is the mLayout used to represent a single list item. You will be
   ...
   * item that needs
   * to be displayed. The arguments correspond to the mLayout and mModelClass given to the
