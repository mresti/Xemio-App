...
/**
 * Populates the list_view_treatment_lists inside AdviceListFragment
 */
public class AdviceListAdapter extends FirebaseListAdapter<Advice> {

  /**
   * Public constructor that initializes private instance variables when adapter is created
   */
  public AdviceListAdapter(Activity activity, Class<Advice> modelClass, int modelLayout,
      Query ref) {
